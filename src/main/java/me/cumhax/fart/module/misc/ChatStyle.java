...
public class ChatStyle extends Module
{
	...
	private final Setting bracketStyle = new Setting("Brackets", this, Arrays.asList("<->", "[-]", "{-}", ":", "None"));
	private final Setting timestampColor = new Setting("TimeColor", this, Arrays.asList("Black", "Red", "Aqua", "Blue", "Gold", "Gray", "White", "Green", "Yellow", "Purple", "DRed", "DAqua", "DBlue", "DGray", "DGreen", "DPurple", "Reset"));
	private final Setting timestampBracket = new Setting("TBracket", this, Arrays.asList("<->", "[-]", "{-}", "None"));
	private final Setting timestampBracketColor = new Setting("TBColor", this, Arrays.asList("Black", "Red", "Aqua", "Blue", "Gold", "Gray", "White", "Green", "Yellow", "Purple", "DRed", "DAqua", "DBlue", "DGray", "DGreen", "DPurple", "Reset"));
	private final Setting bracketColor = new Setting("BColor", this, Arrays.asList("Black", "Red", "Aqua", "Blue", "Gold", "Gray", "White", "Green", "Yellow", "Purple", "DRed", "DAqua", "DBlue", "DGray", "DGreen", "DPurple", "Reset"));
	private final Setting nameColor = new Setting("NameColor", this, Arrays.asList("Black", "Red", "Aqua", "Blue", "Gold", "Gray", "White", "Green", "Yellow", "Purple", "DRed", "DAqua", "DBlue", "DGray", "DGreen", "DPurple", "Reset"));
	private final Setting messageColor = new Setting("MsgColor", this, Arrays.asList("Black", "Red", "Aqua", "Blue", "Gold", "Gray", "White", "Green", "Yellow", "Purple", "DRed", "DAqua", "DBlue", "DGray", "DGreen", "DPurple", "Reset"));
