...
// xatz
public class PenisESP extends Module implements me.cumhax.fart.util.OverrideThin {
    ...
    public String array_detail () {
        if (mc.player.getName().equals("CumHax") || mc.player.getName().equals("Nigger") || mc.player.getName().equals("Cum")) {
            return "BIG";
        }else{
            return "smol";
