...
import me.cumhax.fart.util.HoleUtil;
...
public class HoleESP extends Module
{
    ...
    public HoleESP() {
        ...
        this.addSetting(this.ignoreOwn);
        this.addSetting(this.holeMode);
        this.addSetting(this.place);
        this.addSetting(this.obsidianRed);
        this.addSetting(this.obsidianGreen);
        this.addSetting(this.obsidianBlue);
        this.addSetting(this.obsidianAlpha);
        this.addSetting(this.bedrockRed);
        this.addSetting(this.bedrockBlue);
        this.addSetting(this.bedrockBlue);
        this.addSetting(this.bedrockAlpha);
    }
